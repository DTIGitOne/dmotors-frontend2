...
const Settings = () => {
   ...
   return(
      <div className=" h-screen w-screen bg-slate-100 flex flex-col">
         ...
         <div id="settingsBoxBox" className=" h-auto w-full flex flex-col justify-center items-center">
            <div onClick={userSettings} className=" cursor-pointer h-20 bg-white rounded-3xl p-3 pl-5 shadow-lg" style={{width: "95%"}}>
            ...
            <div onClick={profileSettings} className=" cursor-pointer mt-5 h-20 bg-white rounded-3xl p-3 pl-5 shadow-lg" style={{width: "95%"}}>
            ...
            <div onClick={deleteUser} className=" cursor-pointer mt-5 h-20 bg-white rounded-3xl p-3 pl-5 shadow-lg" style={{width: "95%"}}>
